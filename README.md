...
- Clone this repo:
```
git clone https://github.com/SkullGG-Ui/slam-MaxMirrorBot
cd mirrorbot
```
...
- `DATABASE_URL`: Your Database URL. See [Generate Database](https://github.com/SkullGG-Ui/slam-MaxMirrorBot/tree/master#generate-database) to generate database (**NOTE**: If you use database you can save your Sudo ID permanently using `/addsudo` command).
...
<p><a href="https://github.com/SkullGG-Ui/slam-MaxMirrorBot/wiki/Bot-commands-to-be-set-in-BotFather"> <img src="https://img.shields.io/badge/See%20On%20Wiki-grey?style=for-the-badge&logo=github" width="160""/></a></p>
...
**NOTE**: If you want to use port other than 80, change it in [docker-compose.yml](https://github.com/SkullGG-Ui/slam-MaxMirrorBot/blob/master/docker-compose.yml)
...
<p><a href="https://github.com/SkullGG-Ui/slam-MaxMirrorBot/wiki/Deploying-slam-mirrorbot-on-Heroku-with-Github-Workflows"> <img src="https://img.shields.io/badge/Deploy%20Guide-blueviolet?style=for-the-badge&logo=heroku" width="170""/></a></p>
...
# Youtube-dl authentication using [.netrc](https://github.com/SkullGG-Ui/slam-MaxMirrorBot/blob/master/.netrc) file
...
And many more people who aren't mentioned here, but can be found in [Contributors](https://github.com/SkullGG-Ui/slam-MaxMirrorBot/graphs/contributors).
